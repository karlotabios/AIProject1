...
public class IslandHopper {
	...
	public static void main(String[] args) throws Exception {
		...
		if ((args.length % 2 != 0) || (args.length == 0)) {
			System.out.println("Missing parameter values; check your parameters; arg length: " + args.length);
			errorMessage();
			return;
		}
		...
		// two numbers after strategy is identified are initial location/island, goal
		// island
